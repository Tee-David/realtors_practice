...
- [ ] Workflow file exists at `.github/workflows/scrape-production.yml`
...
- Check workflow file syntax (`.github/workflows/scrape-production.yml`)
...
2. **Verify workflow file syntax**:
   ...
   actionlint .github/workflows/scrape-production.yml
   ```
...
3. **Enable debug logging**:
   Edit workflow `.github/workflows/scrape-production.yml`:
   ```yaml
   env:
...
cat .github/workflows/scrape-production.yml
