...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 flex flex-col md:flex-row w-full">
      ...
      <div className="flex-1 flex flex-col min-h-screen w-full">
        <main
          className="flex-1 overflow-auto bg-slate-50 dark:bg-slate-900 p-2 sm:p-4 pt-16 md:pt-2"
          key={activeTab}
        >
