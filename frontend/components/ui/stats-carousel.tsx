...
function StatsCarousel({
  ...
  return (
    <div className="text-5xl font-extrabold text-white dark:text-white">
      {displayValue}
      {suffix}
    </div>
  );
...
export default function StatsCarouselCount({
  ...
  return (
    <section
      className={`py-8 px-4 w-full max-w-md mx-auto text-center relative h-[350px] z-[40] ${className}`}
    >
        ...
        <AnimatePresence>
          {items.map((stat, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex flex-col items-center justify-center rounded-xl border border-slate-700/50 p-6 bg-slate-900/80 backdrop-blur-md shadow-lg ${
                ...
                >
                  ...
                  <p className="text-xs text-slate-300 mt-2 text-center uppercase tracking-wide">
                    {stat.label}
                  </p>
                </div>
              </motion.div>
